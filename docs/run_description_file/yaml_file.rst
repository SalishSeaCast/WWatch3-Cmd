...
The :kbd:`paths` section of the run description file is a collection of directory paths that :program:`wwatch3` uses to find files in other repos that it needs.
...
.. code-block:: bash
    ...
    $ wwatch3 prepare SoGwaves.yaml

    wwatch3_cmd.prepare INFO: Created temporary run directory: $SCRATCH/MIDOSS/wwatch3-runs/SoGwaves_2019-09-28T134143.750477-0800
